...
/**
 * Api services for the `GrupoPalavraChave` model.
 */
@Injectable()
export class GrupoPalavraChaveApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id GrupoPalavraChave id
   *
   ...
   * This usually means the response is a `GrupoPalavraChave` object.)
   * </em>
   */
  public findByIdPalavraChaveAds(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GrupoPalavraChaves/:id/palavraChaveAds/:fk";
  ...
  public getPalavraChaveAds(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GrupoPalavraChaves/:id/palavraChaveAds";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public countPalavraChaveAds(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GrupoPalavraChaves/:id/palavraChaveAds/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * @param {any} id GrupoPalavraChave id
   *
   * @param {any} nk Foreign key for palavraChaveAds.
   *
   ...
   * </em>
   */
  public getPalavraChaveAdsGanhoDorCanvasMySql(id: any, nk: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GrupoPalavraChaves/:id/palavraChaveAds/:nk/ganhoDorCanvasMySql";
    let _routeParams: any = {
      id: id,
      nk: nk
    };
