...
export class PresencaLojaApi extends BaseLoopBackApi {
  ...
  public findByIdCampanhaAds(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PresencaLojas/:id/campanhaAds/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Queries campanhaAds of PresencaLoja.
   *
   * @param {any} id PresencaLoja id
   *
   * @param {object} filter 
  ...
  /**
   * Counts campanhaAds of PresencaLoja.
   *
   * @param {any} id PresencaLoja id
   *
  ...
  public countCampanhaAds(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PresencaLojas/:id/campanhaAds/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public CalculaMetrica(customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PresencaLojas/calculaMetrica";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
