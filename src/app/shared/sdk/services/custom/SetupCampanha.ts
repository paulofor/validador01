...
/**
 * Api services for the `SetupCampanha` model.
 */
@Injectable()
export class SetupCampanhaApi extends BaseLoopBackApi {
  ...
  public findByIdCampanhaAds(id: any, fk: any, customHeaders?: Function): Observable<any> {
    ...
    "/SetupCampanhas/:id/campanhaAds/:fk";
  ...
  /**
   * Queries campanhaAds of SetupCampanha.
   *
   * @param {any} id SetupCampanha id
   *
   * @param {object} filter 
  ...
  /**
   * Counts campanhaAds of SetupCampanha.
   *
   * @param {any} id SetupCampanha id
   *
  ...
  public countCampanhaAds(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/SetupCampanhas/:id/campanhaAds/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
