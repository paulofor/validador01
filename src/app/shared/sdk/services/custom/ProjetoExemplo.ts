...
/**
 * Api services for the `ProjetoExemplo` model.
 */
@Injectable()
export class ProjetoExemploApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id ProjetoExemplo id
   *
  ...
  public findByIdMvpCanvasMySqls(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProjetoExemplos/:id/mvpCanvasMySqls/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  public findByIdGanhoDorCanvasMySqls(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProjetoExemplos/:id/ganhoDorCanvasMySqls/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Queries projetoCanvasMySqls of ProjetoExemplo.
   *
   * @param {any} id ProjetoExemplo id
   *
   * @param {object} filter 
  ...
  public getProjetoCanvasMySqls(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProjetoExemplos/:id/projetoCanvasMySqls";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts projetoCanvasMySqls of ProjetoExemplo.
   *
   * @param {any} id ProjetoExemplo id
   *
  ...
  public countProjetoCanvasMySqls(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProjetoExemplos/:id/projetoCanvasMySqls/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries mvpCanvasMySqls of ProjetoExemplo.
   *
   * @param {any} id ProjetoExemplo id
   *
   * @param {object} filter 
  ...
  public getMvpCanvasMySqls(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProjetoExemplos/:id/mvpCanvasMySqls";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts mvpCanvasMySqls of ProjetoExemplo.
   *
   * @param {any} id ProjetoExemplo id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countMvpCanvasMySqls(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProjetoExemplos/:id/mvpCanvasMySqls/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries ganhoDorCanvasMySqls of ProjetoExemplo.
   *
   * @param {any} id ProjetoExemplo id
   *
   * @param {object} filter 
  ...
  public getGanhoDorCanvasMySqls(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProjetoExemplos/:id/ganhoDorCanvasMySqls";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts ganhoDorCanvasMySqls of ProjetoExemplo.
   *
   * @param {any} id ProjetoExemplo id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countGanhoDorCanvasMySqls(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProjetoExemplos/:id/ganhoDorCanvasMySqls/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
