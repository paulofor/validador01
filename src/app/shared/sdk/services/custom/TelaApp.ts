...
export class TelaAppApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation entidadePut.
   *
   * @param {any} id TelaApp id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getEntidadePut(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/entidadePut";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Fetches belongsTo relation telaEdicao.
   *
   * @param {any} id TelaApp id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getTelaEdicao(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/telaEdicao";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Fetches belongsTo relation telaDisplay.
   *
   * @param {any} id TelaApp id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getTelaDisplay(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/telaDisplay";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Fetches belongsTo relation modeloTelaApp.
   *
   * @param {any} id TelaApp id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getModeloTelaApp(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/modeloTelaApp";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Find a related item by id for componenteApps.
   *
   * @param {any} id TelaApp id
   *
   * @param {any} fk Foreign key for componenteApps
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdComponenteApps(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/componenteApps/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Delete a related item by id for componenteApps.
   *
   * @param {any} id TelaApp id
   *
   * @param {any} fk Foreign key for componenteApps
   ...
   * This method returns no data.
   */
  public destroyByIdComponenteApps(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/componenteApps/:fk";
    let _routeParams: any = {
  ...
  /**
   * Update a related item by id for componenteApps.
   *
   * @param {any} id TelaApp id
   *
   * @param {any} fk Foreign key for componenteApps
   ...
   * </em>
   */
  public updateByIdComponenteApps(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/componenteApps/:fk";
    let _routeParams: any = {
  ...
  /**
   * Find a related item by id for versaoTelaApps.
   *
   * @param {any} id TelaApp id
   *
   * @param {any} fk Foreign key for versaoTelaApps
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdVersaoTelaApps(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/versaoTelaApps/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Delete a related item by id for versaoTelaApps.
   *
   * @param {any} id TelaApp id
   *
   * @param {any} fk Foreign key for versaoTelaApps
   ...
   * This method returns no data.
   */
  public destroyByIdVersaoTelaApps(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/versaoTelaApps/:fk";
    let _routeParams: any = {
  ...
  /**
   * Update a related item by id for versaoTelaApps.
   *
   * @param {any} id TelaApp id
   *
   * @param {any} fk Foreign key for versaoTelaApps
   ...
   * </em>
   */
  public updateByIdVersaoTelaApps(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/versaoTelaApps/:fk";
    let _routeParams: any = {
  ...
  /**
   * Queries componenteApps of TelaApp.
   *
   * @param {any} id TelaApp id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getComponenteApps(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/componenteApps";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Creates a new instance in componenteApps of this model.
   *
   * @param {any} id TelaApp id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createComponenteApps(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/componenteApps";
    let _routeParams: any = {
  ...
  /**
   * Deletes all componenteApps of this model.
   *
   * @param {any} id TelaApp id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteComponenteApps(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/componenteApps";
    let _routeParams: any = {
  ...
  /**
   * Counts componenteApps of TelaApp.
   *
   * @param {any} id TelaApp id
   *
   * @param {object} where Criteria to match model instances
   ...
   *  - `count` – `{number}` - 
   */
  public countComponenteApps(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/componenteApps/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries versaoTelaApps of TelaApp.
   *
   * @param {any} id TelaApp id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getVersaoTelaApps(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/versaoTelaApps";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Creates a new instance in versaoTelaApps of this model.
   *
   * @param {any} id TelaApp id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createVersaoTelaApps(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/versaoTelaApps";
    let _routeParams: any = {
  ...
  /**
   * Deletes all versaoTelaApps of this model.
   *
   * @param {any} id TelaApp id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteVersaoTelaApps(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/versaoTelaApps";
    let _routeParams: any = {
  ...
  /**
   * Counts versaoTelaApps of TelaApp.
   *
   * @param {any} id TelaApp id
   *
   * @param {object} where Criteria to match model instances
   ...
   *  - `count` – `{number}` - 
   */
  public countVersaoTelaApps(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/versaoTelaApps/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public TelasAppPorIdEntidadeParaGerador(idEntidade: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/telasAppPorIdEntidadeParaGerador";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
   ...
   * </em>
   */
  public DisponivelParaVersaoApp(idVersaoApp: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/disponivelParaVersaoApp";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
   ...
   * </em>
   */
  public createManyComponenteApps(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/componenteApps";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyVersaoTelaApps(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TelaApps/:id/versaoTelaApps";
    let _routeParams: any = {
