...
export class VersaoAppApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation telaAppInicial.
   *
   * @param {any} id VersaoApp id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getTelaAppInicial(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/telaAppInicial";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public findByIdClienteExperimentals(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/clienteExperimentals/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  public findByIdDispositivoUsuarios(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/dispositivoUsuarios/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Find a related item by id for valorVersaos.
   *
   * @param {any} id VersaoApp id
   *
   * @param {any} fk Foreign key for valorVersaos
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdValorVersaos(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/valorVersaos/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Delete a related item by id for valorVersaos.
   *
   * @param {any} id VersaoApp id
   *
   * @param {any} fk Foreign key for valorVersaos
   ...
   * This method returns no data.
   */
  public destroyByIdValorVersaos(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/valorVersaos/:fk";
    let _routeParams: any = {
  ...
  /**
   * Update a related item by id for valorVersaos.
   *
   * @param {any} id VersaoApp id
   *
   * @param {any} fk Foreign key for valorVersaos
   ...
   * </em>
   */
  public updateByIdValorVersaos(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/valorVersaos/:fk";
    let _routeParams: any = {
  ...
  /**
   * Queries visitantes of VersaoApp.
   *
   * @param {any} id VersaoApp id
   *
   * @param {object} filter 
  ...
  /**
   * Counts visitantes of VersaoApp.
   *
   * @param {any} id VersaoApp id
   *
  ...
  public countVisitantes(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/visitantes/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries campanhaAds of VersaoApp.
   *
   * @param {any} id VersaoApp id
   *
   * @param {object} filter 
  ...
  /**
   * Counts campanhaAds of VersaoApp.
   *
   * @param {any} id VersaoApp id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countCampanhaAds(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/campanhaAds/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries clienteExperimentals of VersaoApp.
   *
   * @param {any} id VersaoApp id
   *
   * @param {object} filter 
  ...
  public getClienteExperimentals(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/clienteExperimentals";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts clienteExperimentals of VersaoApp.
   *
   * @param {any} id VersaoApp id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countClienteExperimentals(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/clienteExperimentals/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries dispositivoUsuarios of VersaoApp.
   *
   * @param {any} id VersaoApp id
   *
   * @param {object} filter 
  ...
  public getDispositivoUsuarios(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/dispositivoUsuarios";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts dispositivoUsuarios of VersaoApp.
   *
   * @param {any} id VersaoApp id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countDispositivoUsuarios(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/dispositivoUsuarios/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries valorVersaos of VersaoApp.
   *
   * @param {any} id VersaoApp id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getValorVersaos(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/valorVersaos";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Creates a new instance in valorVersaos of this model.
   *
   * @param {any} id VersaoApp id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createValorVersaos(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/valorVersaos";
    let _routeParams: any = {
  ...
  /**
   * Deletes all valorVersaos of this model.
   *
   * @param {any} id VersaoApp id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteValorVersaos(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/valorVersaos";
    let _routeParams: any = {
  ...
  /**
   * Counts valorVersaos of VersaoApp.
   *
   * @param {any} id VersaoApp id
   *
   * @param {object} where Criteria to match model instances
   ...
   *  - `count` – `{number}` - 
   */
  public countValorVersaos(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/valorVersaos/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyValorVersaos(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoApps/:id/valorVersaos";
    let _routeParams: any = {
