...
/**
 * Api services for the `Cosmetic_Produto` model.
 */
@Injectable()
export class Cosmetic_ProdutoApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Cosmetic_Produto` object.)
   * </em>
   */
   ...
   *
   * @param {any} id Cosmetic_Produto id
   *
   * @param {object} data Request data.
   *
  ...
  public ListaAppComputador(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = URL_COSMETIC + "/" + LoopBackConfig.getApiVersion() +
    "/Cosmetic_Produtos/listaAppComputador";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
