...
export class ConceitoProdutoApi extends BaseLoopBackApi {
  ...
  public findByIdAnuncioAplicativos(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ConceitoProdutos/:id/anuncioAplicativos/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Queries anuncioAplicativos of ConceitoProduto.
   *
   * @param {any} id ConceitoProduto id
   *
   * @param {object} filter 
  ...
  public getAnuncioAplicativos(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ConceitoProdutos/:id/anuncioAplicativos";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts anuncioAplicativos of ConceitoProduto.
   *
   * @param {any} id ConceitoProduto id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countAnuncioAplicativos(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ConceitoProdutos/:id/anuncioAplicativos/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
