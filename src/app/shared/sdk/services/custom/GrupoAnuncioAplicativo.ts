...
/**
 * Api services for the `GrupoAnuncioAplicativo` model.
 */
@Injectable()
export class GrupoAnuncioAplicativoApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id GrupoAnuncioAplicativo id
   *
   ...
   * This usually means the response is a `GrupoAnuncioAplicativo` object.)
   * </em>
   */
  public getAnuncioAplicativo(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GrupoAnuncioAplicativos/:id/anuncioAplicativo";
