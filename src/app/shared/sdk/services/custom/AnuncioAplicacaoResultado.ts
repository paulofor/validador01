...
/**
 * Api services for the `AnuncioAplicacaoResultado` model.
 */
@Injectable()
export class AnuncioAplicacaoResultadoApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id AnuncioAplicacaoResultado id
   *
   ...
   * This usually means the response is a `AnuncioAplicacaoResultado` object.)
   * </em>
   */
  public getAnuncioAplicativo(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AnuncioAplicacaoResultados/:id/anuncioAplicativo";
  ...
  public getCampanhaAds(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AnuncioAplicacaoResultados/:id/campanhaAds";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
