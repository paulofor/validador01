...
export class AnuncioAplicativoApi extends BaseLoopBackApi {
  ...
  public findByIdAnuncioAplicacaoResultados(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AnuncioAplicativos/:id/anuncioAplicacaoResultados/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Queries anuncioAplicacaoResultados of AnuncioAplicativo.
   *
   * @param {any} id AnuncioAplicativo id
   *
   * @param {object} filter 
  ...
  public getAnuncioAplicacaoResultados(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AnuncioAplicativos/:id/anuncioAplicacaoResultados";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Counts anuncioAplicacaoResultados of AnuncioAplicativo.
   *
   * @param {any} id AnuncioAplicativo id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countAnuncioAplicacaoResultados(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AnuncioAplicativos/:id/anuncioAplicacaoResultados/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public CalculaMedias(customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AnuncioAplicativos/calculaMedias";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public CalculaMetricaProjeto(idProjeto: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AnuncioAplicativos/calculaMetricaProjeto";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
