...
/**
 * Api services for the `ValorEtapaFunilSemana` model.
 */
@Injectable()
export class ValorEtapaFunilSemanaApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id ValorEtapaFunilSemana id
   *
   * @param {object} data Request data.
   *
