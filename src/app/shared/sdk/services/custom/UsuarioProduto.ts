...
export class UsuarioProdutoApi extends BaseLoopBackApi {
  ...
  /**
   * Find a related item by id for visitaApps.
   *
   * @param {any} id UsuarioProduto id
   *
   * @param {any} fk Foreign key for visitaApps
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdVisitaApps(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UsuarioProdutos/:id/visitaApps/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Delete a related item by id for visitaApps.
   *
   * @param {any} id UsuarioProduto id
   *
   * @param {any} fk Foreign key for visitaApps
   ...
   * This method returns no data.
   */
  public destroyByIdVisitaApps(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UsuarioProdutos/:id/visitaApps/:fk";
    let _routeParams: any = {
  ...
  /**
   * Update a related item by id for visitaApps.
   *
   * @param {any} id UsuarioProduto id
   *
   * @param {any} fk Foreign key for visitaApps
   ...
   * </em>
   */
  public updateByIdVisitaApps(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UsuarioProdutos/:id/visitaApps/:fk";
    let _routeParams: any = {
  ...
  /**
   * Queries visitaApps of UsuarioProduto.
   *
   * @param {any} id UsuarioProduto id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getVisitaApps(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UsuarioProdutos/:id/visitaApps";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Creates a new instance in visitaApps of this model.
   *
   * @param {any} id UsuarioProduto id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createVisitaApps(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UsuarioProdutos/:id/visitaApps";
    let _routeParams: any = {
  ...
  /**
   * Deletes all visitaApps of this model.
   *
   * @param {any} id UsuarioProduto id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteVisitaApps(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UsuarioProdutos/:id/visitaApps";
    let _routeParams: any = {
  ...
  /**
   * Counts visitaApps of UsuarioProduto.
   *
   * @param {any} id UsuarioProduto id
   *
   * @param {object} where Criteria to match model instances
   ...
   *  - `count` – `{number}` - 
   */
  public countVisitaApps(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UsuarioProdutos/:id/visitaApps/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public PeriodoGratuito(chave: any, customHeaders?: Function): Observable<any> {
    ...
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof chave !== 'undefined' && chave !== null) _urlParams.chave = chave;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
   ...
   * </em>
   */
  public DesligaEnvioEmail(chave: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UsuarioProdutos/desligaEnvioEmail";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof chave !== 'undefined' && chave !== null) _urlParams.chave = chave;
   ...
   * </em>
   */
  public createManyVisitaApps(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UsuarioProdutos/:id/visitaApps";
    let _routeParams: any = {
