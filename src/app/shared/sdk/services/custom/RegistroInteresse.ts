...
export class RegistroInteresseApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getVisitante(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegistroInteresses/:id/visitante";
   ...
   * </em>
   */
  public getVisitantePaginaValidacaoWeb(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegistroInteresses/:id/visitante/paginaValidacaoWeb";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
