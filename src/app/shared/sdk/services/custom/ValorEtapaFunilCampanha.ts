...
/**
 * Api services for the `ValorEtapaFunilCampanha` model.
 */
@Injectable()
export class ValorEtapaFunilCampanhaApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id ValorEtapaFunilCampanha id
   *
  ...
  public getEtapaCliente(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    "/ValorEtapaFunilCampanhas/:id/etapaCliente";
  ...
  public getCampanhaAds(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ValorEtapaFunilCampanhas/:id/campanhaAds";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public AtualizaValorFunil(customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ValorEtapaFunilCampanhas/atualizaValorFunil";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
